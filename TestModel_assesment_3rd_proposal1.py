...
class TestModel:
    ...
    def load_prepare_data_assesment(self):
        ...
        dataset = read_csv(os.path.join(mainDir,'TheData\\PVs for assessments.csv'), header=0, index_col=0, parse_dates=True)
...
f = TestModel(outputIndex=-1,comment="assesment3")
f.start_experiment()
