...
class GA:
    ...
    def steady_state_selection(self, fitness, num_parents):
        ...
        parents = numpy.empty((num_parents, self.population.shape[1]),dtype=type(self.population[0,0]))
    ...
    def single_point_crossover(self, parents, offspring_size):
        ...
        offspring = numpy.empty(offspring_size , dtype=type(self.population[0,0]))
